...
/**
 * Patterns Sift. Frontend controller entry point.
 */
class MyController extends SiftController {
  ...
  loadView(state) {
    console.log('patterns: loadView', state);
    ...
    switch (state.type) {
      ...
      default:
        console.error('patterns: unknown Sift type: ', state.type);
    }
  }

  // Event: storage update
  // onStorageUpdate(value) {
  //   console.log('patterns: onStorageUpdate: ', value);
  ...
  //     bucket: 'x'
  //   }).then((values) => {
  //     console.log('patterns: getX returned:', values);
  //     return {};
  //   });
  // }
